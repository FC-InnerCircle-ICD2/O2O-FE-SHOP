        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col gap-6 px-[30px] py-4">
            <div className="flex gap-10 items-start">
              <p className="text-2xl w-[100px] font-bold">사장님께</p>
              <p className="text-2xl flex-1 font-medium text-zinc-700">맵지 않게 해주세요.</p>
            </div>
            <div className="flex gap-10 items-start">
              <p className="text-2xl w-[100px] font-bold">라이더님께</p>
              <p className="text-2xl flex-1 font-medium text-zinc-700">안전하게 와주세요.</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col gap-6 px-[30px] py-4">
            <dl className="flex gap-10">
              <dt className="text-2xl w-[100px] font-bold">주문자</dt>
              <dd className="text-2xl font-medium text-zinc-700">홍길동</dd>
            </dl>
            <dl className="flex gap-10">
              <dt className="text-2xl w-[100px] font-bold">주소</dt>
              <dd className="text-2xl font-medium text-zinc-700">서울시 강남구 역삼동</dd>
            </dl>
            <dl className="flex gap-10">
              <dt className="text-2xl w-[100px] font-bold">휴대폰번호</dt>
              <dd className="text-2xl font-medium text-zinc-700">010-xxxx-5678</dd>
            </dl>
          </div>
        </div>
      </div>
