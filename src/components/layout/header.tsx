...
export function Header() {
  ...
  return (
    <SidebarHeader className="flex items-center justify-center h-[8rem] py-[1.8rem] px-[3rem] border-b border-b-solid border-b-black">
      <SidebarMenu className="flex-1">
        <SidebarMenuItem className="flex flex-1 items-center justify-center">
          ...
          >
            <p className="font-jua flex-1 text-[2.8rem] leading-[2.8rem] font-bold text-white">
              개발의 민족
            </p>
          </SidebarMenuButton>
        </SidebarMenuItem>
